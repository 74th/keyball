...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE_MAC] = LAYOUT_universal(
    ...
    ESC_EN_MAC, _______,    _______,    ESC_EN_MAC, CTL_TAB,    CMD_EN_MAC, KC_SPC,         RAISE_ENT,    ALT_JA_MAC, KC_BSPC,    KC_A,       KC_B,       KC_BSPC,    MO(_DOUBLE)
  ),
  ...
  [_LINUX] = LAYOUT_universal(
    ...
    ESC_EN_LNX, _______,    _______,    ESC_EN_LNX, ALT_TAB,    CTL_EN_LNX,   _______,        _______,    GUI_JA_LNX, _______,    _______,    _______,    _______,    _______
  ),
  ...
  [_RAISE] = LAYOUT_universal(
    ...
    _______,    _______,    _______,    _______,    _______,    _______,      C(KC_SPC),      _______,    KC_BSPC,  KC_DEL,       _______,    _______,    _______,    _______
  ),
  ...
  [_CTL] = LAYOUT_universal(
    ...
    _______,    _______,    _______,    _______,    SCRL_MO,    KC_MS_BTN1,    KC_MS_BTN2,     _______,   _______,    _______,    _______,    _______,    _______,    _______
  ),
};
// clang-format on
