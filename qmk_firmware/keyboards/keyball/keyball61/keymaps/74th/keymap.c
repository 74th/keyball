...
#define L2_ENT_MAC LT(_MAC_L2, KC_ENT)
#define L2_ENT_LNX LT(_LINUX_L2, KC_ENT)

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_LINUX_L1] = LAYOUT_right_ball(
    ALT_GRV,    KC_1,       KC_2,       KC_3,       KC_4,       KC_5,                                 KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,    MO(_L3),
    ...
    SCRL_MO,    KC_MS_BTN1, KC_MS_BTN2, ESC_EN_LNX, ALT_TAB,    CTL_EN_LNX, KC_SPC,       L2_ENT_LNX, GUI_JA_LNX,                                     KC_BSPC,    MO(_L3)
  ),
  ...
  [_LINUX_L2] = LAYOUT_right_ball(
   C(A(KC_F2)), G(KC_F1), S(G(KC_F2)),  G(KC_F3),   G(KC_F4),   C(A(KC_ESC)),                         G(KC_F7),   G(KC_F8),   G(KC_F9),   G(KC_F10),  _______,   MO(_L3),
    ...
    _______,    _______,    _______,    A(KC_PSCR), S(KC_PSCR), KC_F12,     KC_6,         KC_F6,      KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_HOME,    KC_END,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,      _______,    _______,                                        _______,    _______
  ),

  [_MAC_L1] = LAYOUT_right_ball(
    _______,    _______,    _______,    _______,    _______,    _______,                              _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,                              _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,                              _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,      _______,    _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    ESC_EN_MAC, CTL_TAB,    CMD_EN_MAC, _______,      L2_ENT_MAC, ALT_JA_MAC,                                     _______,    _______
  ),

  [_MAC_L2] = LAYOUT_right_ball(
    C(A(KC_Q)), G(KC_F1), S(G(KC_F2)),  G(KC_F3),   G(KC_F4),   G(KC_F5),                             G(KC_F6),   G(KC_F7),   G(KC_F8),   G(KC_F9),   _______,    MO(_L3),
    KC_ESC,     KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,                                KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,
    KC_LCTL,    S(KC_1),    S(KC_2),    S(KC_3),    S(KC_4),    S(KC_5),                              S(KC_6),    S(KC_7),    S(KC_8),    S(KC_9),    S(KC_0),    S(KC_MINS),
    _______,    _______,    _______,    S(G(KC_3)), S(G(KC_4)), KC_F12,     KC_6,         KC_F6,      KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_HOME,    KC_END,
    _______,    _______,    _______,    _______,    _______,    _______,    C(KC_SPC),    _______,    KC_BSPC,                                        _______,    _______
  ),

  [_L3] = LAYOUT_right_ball(
